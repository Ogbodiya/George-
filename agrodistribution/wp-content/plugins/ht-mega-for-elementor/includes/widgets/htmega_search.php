                                ...
                                <div class="box-search-content search_active block-bg close__top minisearch">
                                    <div class="field__search">
                                        ...
                                        <div class="action">
                                            <?php 
                                                if( $settings['search_btn_icon_type'] == 'icon' ) {
                                                    echo sprintf( '<button type="submit" class="btn btn-search %1$s">%2$s</button>',$settings['search_button_icon'],$settings['search_button_text'] );
                                                }else{
                                                    echo sprintf( '<button type="submit" class="btn btn-search">%1$s</button>', $settings['search_button_text'] );
                                                }
                                            ?>
                                        </div>
                                    </div>
