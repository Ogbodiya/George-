                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#ffffff',
                            'selectors' => [
                                '{{WRAPPER}} .htmega-switcher-nav a.active' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'htmega-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-switcher-nav a.active, {{WRAPPER}} .htmega-switcher-nav a.active::before',
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Border', 'htmega-addons' ),
                            'selector' => '{{WRAPPER}} .htmega-switcher-nav a.active',
                        ]
                    );
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'htmega_switcher_attr' ); ?>>
                ...
                <div class="htmega-switcher-btn">
                    <div class="htmega-switcher-nav nav" role="tablist">
                        <a class="nav-link active show" data-toggle="tab" href="#switcherone<?php echo $this->get_id(); ?>">
                            <?php
                        ...
                        <a class="nav-link" data-toggle="tab" href="#switchertwo<?php echo $this->get_id(); ?>">
                            <?php
                ...
                <div class="ht-tab-content tab-content">

                    <!-- Start Single Tab -->
                    <div class="htmega-single-switch tab-pane active show" id="switcherone<?php echo $this->get_id(); ?>" role="tabpanel">
                        <?php
                    ...
                    <div class="htmega-single-switch tab-pane" id="switchertwo<?php echo $this->get_id(); ?>" role="tabpanel">
                        <?php
