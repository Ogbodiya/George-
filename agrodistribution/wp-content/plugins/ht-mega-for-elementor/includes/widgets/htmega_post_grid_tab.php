        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'htmega_post_gridtab' ); ?>>
                ...
                ?>
                    ...
                    ?>
                        <div class="post-gridthumb-<?php echo $id; ?> post-grid post-grid-four order-<?php echo esc_attr__( $countrow );?>">
                            <div class="thumb">
                        ...
                        <!-- Grid Content -->
                        <div class="post-gridcontent-<?php echo $id; ?> post-content order-<?php echo esc_attr__( $order_content ); if( $countrow == 1 ){ echo ' is-visible'; } ?>">
                    ...
                    ?>
                        ...
                        <div class="post-gridthumb-<?php echo $id; ?> post-grid order-<?php echo esc_attr__( $countrow ); echo ' '.esc_attr__( $item_class ); ?>">
                            <div class="thumb">
                                <a href="<?php the_permalink();?>">
                         ...
                         <div class="post-gridcontent-<?php echo $id; ?> post-content order-<?php echo esc_attr__( $order_content );  ?>">
                            <?php $this->render_post_content(0, $id); ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="post-gridthumb-<?php echo $id; ?> post-grid order-<?php echo esc_attr__( $countrow ); echo ' '.esc_attr__( $item_class ); ?> gradient-overlay gradient-overlay-<?php echo esc_attr__( $gdc );?>">
                            <div class="thumb">
                                <a href="<?php the_permalink();?>">
                                    <?php the_post_thumbnail(); ?>
                                </a>
