        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .bs-popover-auto[x-placement^=top]' => 'top: -{{SIZE}}{{UNIT}} !important;',
                        '{{WRAPPER}} .bs-popover-top' => 'top: -{{SIZE}}{{UNIT}} !important;',
                        '{{WRAPPER}} .bs-popover-auto[x-placement^=bottom]' => 'top: {{SIZE}}{{UNIT}} !important;',
                        '{{WRAPPER}} .bs-popover-bottom' => 'top: {{SIZE}}{{UNIT}} !important;',
                        '{{WRAPPER}} .bs-popover-auto[x-placement^=right]' => 'left: {{SIZE}}{{UNIT}} !important;',
                        '{{WRAPPER}} .bs-popover-right' => 'left: {{SIZE}}{{UNIT}} !important;',
                        '{{WRAPPER}} .bs-popover-auto[x-placement^=left]' => 'left: {{SIZE}}{{UNIT}} !important;',
                        '{{WRAPPER}} .bs-popover-left' => 'left: -{{SIZE}}{{UNIT}} !important;',
                    ],
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .popover' => 'max-width: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .popover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                            'selector' => '{{WRAPPER}} .popover .popover-header',
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#262626',
                            'selectors' => [
                                '{{WRAPPER}} .popover .popover-header' => 'color: {{VALUE}} !important;',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .popover .popover-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                            ],
                            'separator' =>'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .popover .popover-header' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .popover .popover-header' => 'text-align: {{VALUE}};',
                            ],
                            'default' => 'left',
                            'separator' =>'before',
                        ]
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                            'selector' => '{{WRAPPER}} .popover .popover-body',
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#262626',
                            'selectors' => [
                                '{{WRAPPER}} .popover .popover-body' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .popover .popover-body' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' =>'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .popover .popover-body' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .popover .popover-body' => 'text-align: {{VALUE}};',
                            ],
                            'default' => 'left',
                            'separator' =>'before',
                        ]
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#e0e0e0',
                            'selectors' => [
                                '{{WRAPPER}} .bs-popover-auto[x-placement^=top] .arrow::before' => 'border-top-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .bs-popover-top .arrow::before' => 'border-top-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .bs-popover-auto[x-placement^=bottom] .arrow::before' => 'border-bottom-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .bs-popover-bottom .arrow::before' => 'border-bottom-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .bs-popover-auto[x-placement^=left] .arrow::before' => 'border-left-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .bs-popover-left .arrow::before' => 'border-left-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .bs-popover-auto[x-placement^=right] .arrow::before' => 'border-right-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .bs-popover-right .arrow::before' => 'border-right-color: {{VALUE}} !important;',
                            ],
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'default' => '#ffffff',
                            'selectors' => [
                                '{{WRAPPER}} .popover.bs-popover-auto[x-placement^="top"] .arrow::after' => 'border-top-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .popover.bs-popover-top .arrow::after' => 'border-top-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .popover.bs-popover-auto[x-placement^="bottom"] .arrow::after' => 'border-top-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .popover.bs-popover-bottom .arrow::after' => 'border-bottom-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .popover.bs-popover-auto[x-placement^="left"] .arrow::after' => 'border-left-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .popover.bs-popover-left .arrow::after' => 'border-left-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .popover.bs-popover-auto[x-placement^="right"] .arrow::after' => 'border-right-color: {{VALUE}} !important;',
                                '{{WRAPPER}} .popover.bs-popover-right .arrow::after' => 'border-right-color: {{VALUE}} !important;',
                            ],
                        ]
                    );
