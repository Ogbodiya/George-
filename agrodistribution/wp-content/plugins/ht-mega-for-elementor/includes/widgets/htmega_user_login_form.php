    ...
    protected function render( $instance = [] ) {
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string( 'loginform_area_attr' ); ?> >
                ...
                <div id="htmega_message_<?php echo esc_attr__( $id, 'htmega-addons' ); ?>" class="htmega_message">&nbsp;</div>
                ...
                <form id="htmega_login_form_<?php echo esc_attr__( $id, 'htmega-addons' ); ?>" action="formloginaction" method="post">
