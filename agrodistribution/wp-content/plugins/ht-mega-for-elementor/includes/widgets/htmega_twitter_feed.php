...
class HTMega_Elementor_Widget_Twitter_Feed extends Widget_Base {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'placeholder' => __( 'devitemsllc', 'htmega-addons' ),
                    'label_block' => true,
                    'separator' => 'before',
                ]
            );
    ...
    protected function render( $instance = [] ) {
        ...
        $consumer_key = ( !empty( $settings['consumer_key'] ) ) ? $settings['consumer_key'] : 'qhwSleIMtLeRbqYY2kabwLCc0';
        $consumer_secret = ( !empty( $settings['consumer_secret'] ) ) ? $settings['consumer_secret'] : '00WTXq2fxd0W7i3mHqBsT6Bjm81eIYvNFbCcoHfW2bIIvVxDQX';
        $access_token = ( !empty( $settings['access_token'] ) ) ? $settings['access_token'] : '3750582733-C9SXrSxDNLTWF6QWShAoKZfxqR5xQ0yfNzgQu6X';
        $access_token_secret = ( !empty( $settings['access_token_secret'] ) ) ? $settings['access_token_secret'] : 'SclQ7mmInfFUqhL0dEQf561g6tkOXLNEzWmei9g1qtePf';
        $username = ( !empty( $settings['username'] ) ) ? $settings['username'] : 'devitemsllc';
                        ...
                        <div class="htmega-twitter-single">
                            <div class="ht-twitter-container">
                                ...
                                <div class="htmega-content">
                                    ...
                                    <?php endif;?>
                                    <p><?php echo wp_trim_words( $tweet->text, $settings['content_length'], ' ' ); ?> <a href="<?php echo esc_url($tweet_short_link ); ?>" target="_blank"><?php echo esc_attr( $tweet_short_link ); ?></a></p>
