...
class HTMega_Elementor_Widget_Accordion extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'accordion_uniqid',
                [
                    'label' => __( 'Accourdion Uniq Id', 'htmega-addons' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'accordionone', 'htmega-addons' ),
                    'condition' => [
                        'accordiantstyle' =>'one',
                    ],
                ]
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector' => '{{WRAPPER}} .collapsed.htmega-items-hedding',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .collapsed.htmega-items-hedding' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .collapsed.htmega-items-hedding' => 'color: {{VALUE}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'htmega-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-accourdion-title .htmega-items-hedding.collapsed .accourdion-icon',
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-accourdion-title .htmega-items-hedding.collapsed .accourdion-icon' => 'color: {{VALUE}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-accourdion-title .htmega-items-hedding.collapsed .accourdion-icon' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .htmega-accourdion-title .htmega-items-hedding.collapsed .accourdion-icon' => 'line-height: {{SIZE}}{{UNIT}};',
                            ],
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $accordion_id       = $settings['accordion_uniqid'];
        $this->add_render_attribute( 'accordion_heading', 'data-toggle', 'collapse' );
                                ...
                                <div class="htmega-accourdion-title">
                                    <?php
                                        if( ( $current_item == $i ) && ( $settings['accordion_close_all'] != 'yes' ) ){
                                            ...
                                            echo sprintf('<%1$s %2$s data-target="#htmega-collapse%3$s" class="collapsed htmega-items-hedding">%4$s %5$s</%1$s>', $settings['accourdion_title_html_tag'], $this->get_render_attribute_string( 'accordion_heading' ), $j, $item['accordion_title'], $buttonicon );
                                        }
                                    ?>
                                </div>

                                <div id="htmega-collapse<?php echo $j;?>" class="collapse <?php if( ( $current_item == $i ) && ( $settings['accordion_close_all'] != 'yes' ) ){ echo 'show'; }?>" <?php if( $settings['accordion_multiple'] != 'yes' ){ echo 'data-parent="#accordionExample'.$accordion_id.'"'; } ?> >
                                    <div class="accordion-content">
                                        <?php 
