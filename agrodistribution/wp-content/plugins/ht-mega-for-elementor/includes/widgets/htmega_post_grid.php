...
class HTMega_Elementor_Widget_PostGrid extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        <div <?php echo $this->get_render_attribute_string( 'htmega_post_grid' ); ?>>
            <div class="col">
                <div class="<?php if( $settings['post_grid_style'] == 1 || $settings['post_grid_style'] == 2 || $settings['post_grid_style'] == 3 ) { echo 'row-1'; }else{ echo 'row--10' ;}?> row">
                    <?php
                                    ...
                                    <?php if ( $countrow == 2) : ?>
                                        <div class="col-lg-12">
                                            <div class="ht-post">
                                                <div class="thumb">
                                                    <a href="<?php the_permalink();?>">
                                                        <?php the_post_thumbnail('htmega_size_585x295'); ?>
                                                    </a>
                                                </div>
                                                <?php
                                                    if( $settings['show_category'] == 'yes' ){
