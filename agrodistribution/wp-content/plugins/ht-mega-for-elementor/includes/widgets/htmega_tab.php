...
class HTMega_Elementor_Widget_Tabs extends Widget_Base {
                ...
                $repeater->start_controls_tab(
                    ...
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-tab-nav a.active{{CURRENT_ITEM}}' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $repeater->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'htmega-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-tab-nav a.active{{CURRENT_ITEM}}',
                        ]
                    );
                    ...
                    $repeater->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-tab-nav a.active{{CURRENT_ITEM}} i' => 'color: {{VALUE}}',
                            ],
                            'condition' => [
                                'tab_icon!' => '',
                            ]
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-tab-nav a.active' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'htmega-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-tab-nav a.active',
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'htmega_tab_menu_attr', 'class', 'htmega-tab-nav nav');
                ...
                <div <?php echo $this->get_render_attribute_string( 'htmega_tab_menu_attr' ); ?>>
                    <?php
                        ...
                        foreach ( $settings['htmega_tabs_list'] as $item ) {
                            ...
                            if( $i == 1 ){ $active_tab = 'active show'; } else{ $active_tab = ''; }
                            if( !empty( $item['tab_icon'] ) ){ $tabbuttontxt = '<i class="'.$item['tab_icon'].'"></i>'.$item['tab_title']; }
                            echo sprintf( '<a class="nav-link %1$s %4$s" href="#htmegatab-%2$s" data-toggle="tab" role="tab">%3$s</a>',$active_tab, $id.$i, $tabbuttontxt, 'elementor-repeater-item-'.$item['_id']);
                        }
                    ?>
                </div>

                <div class="htmega-tab-content-area tab-content">
                    <?php
                        $i=0;
                        foreach ( $settings['htmega_tabs_list'] as $item ) {
                            $i++;
                            ...
                            echo sprintf('<div class="htmega-single-tab tab-pane fade %1$s %4$s" id="htmegatab-%2$s" role="tabpanel"><div class="htmega-tab-content">%3$s</div></div>', $active_tab, $id.$i, $tab_content,'elementor-repeater-item-'.$item['_id'] );
                        }
                    ?>
                </div>
