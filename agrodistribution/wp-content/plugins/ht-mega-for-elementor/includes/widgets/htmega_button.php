...
class HTMega_Elementor_Widget_Button extends Widget_Base {
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'selector' => '{{WRAPPER}} .htmega-button .btn',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn:hover' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Border', 'htmega-addons' ),
                            'selector' => '{{WRAPPER}} .htmega-button .btn:hover',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn:hover' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn .htmega_button_icon' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-button .btn .htmega_button_icon',
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::DIMENSIONS,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn .htmega_button_icon' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px;',
                            ],
                            'separator' => 'before',
                        ]
                    );
                    ...
                    $this->add_responsive_control(
                        ...
                        [
                            ...
                            'size_units' => [ 'px', '%', 'em' ],
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn .htmega_button_icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                            ],
                            'separator' => 'before',
                        ]
                    );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .htmega-button .btn:hover .htmega_button_icon' => 'color: {{VALUE}};',
                            ],
                        ]
                    );
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Icon Background', 'htmega-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-button .btn:hover .htmega_button_icon',
                            'separator' => 'before',
                        ]
                    );
    ...
    protected function render( $instance = [] ) {
        ...
        if ( ! empty( $settings['button_link']['url'] ) ) {
            ...
            $this->add_render_attribute( 'url', 'class', 'btn' );
            $this->add_render_attribute( 'url', 'class', 'btn-outline-'. $settings['button_type'] );
