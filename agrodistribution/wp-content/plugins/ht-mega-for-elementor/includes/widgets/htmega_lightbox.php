            ...
            <div class="htmega-lightbox">
                ...
                <div class="htmega-lightbox-action">
                    <?php if( !empty($settings['zoom_icon']) ): ?>
                        <a <?php echo $this->get_render_attribute_string( 'popup_content_attr' ); ?> ><i class="<?php echo esc_attr__( $settings['zoom_icon'], 'htmega-addons' );?>"></i></a>
                    <?php else:?>
                        <a <?php echo $this->get_render_attribute_string( 'popup_content_attr' ); ?> ><?php echo esc_attr__( $settings['zoom_text'], 'htmega-addons' );?></a>
                    <?php endif;?>
                </div>
            </div>
